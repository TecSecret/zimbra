#!/bin/bash
# Author: Nelsir Luterek 
# Website: https://tecsecret.com.br/
# Create time: 27/06/2021
# Description: Este script instala um novo certificado ssl usando certbot 
# Note: Testado no zimbra 9 com CentOS 8
